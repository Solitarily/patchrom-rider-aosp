...
.method private ParseUICCTLVData([B[I)V
    .locals 12
    .parameter "data"
    .parameter "arrayToReturn"
    ...
    .line 330
    const-string v6, "TLV format detected"

    invoke-virtual {p0, v6}, Lcom/android/internal/telephony/IccFileHandler;->logd(Ljava/lang/String;)V

    .line 331
    add-int/lit8 v0, v1, 0x1

    .end local v1           #curByte:I
    .restart local v0       #curByte:I
    aget-byte v2, p1, v1

    .line 332
    .local v2, curSectionLen:I
    array-length v6, p1

    add-int/lit8 v4, v6, -0x2

    .line 333
    .local v4, dataLenLeft:I
    if-eq v2, v4, :cond_0
    ...
    const-string v7, "Unexpected TLV length of "
    ...
    const-string v7, "bytes of data left"
    ...
    const-string v7, "Unexpected TLV data, expecting file descriptor tag, but got "
    ...
    .line 343
    new-instance v6, Lcom/android/internal/telephony/IccFileTypeMismatch;

    invoke-direct {v6}, Lcom/android/internal/telephony/IccFileTypeMismatch;-><init>()V
    ...
    const-string v7, "TLV File Description length of "
    ...
    const-string v7, " is not handled yet"
    ...
    const-string v7, "Unexpected TLV data, expecting file identifier tag, but got "
    ...
    const-string v7, "Unexpected TLV data, expecting Life Cycle Status Integer tag, but got "
    ...
    const-string v7, "Unexpected TLV data, expecting Security Attributes tag, but got "
    ...
    const-string v7, "Unexpected TLV data, expecting File Size tag, but got "
    ...
    const-string v7, "ParseUICCTLVData result: Record Size = "
    ...
    const-string v7, "; Number of Records = "
    ...
    .line 433
    .end local v0           #curByte:I
    .end local v2           #curSectionLen:I
    .end local v3           #curTag:I
    .end local v4           #dataLenLeft:I
    .restart local v1       #curByte:I
    :cond_c
    const-string v6, "Throwing exception : Expecting a TLV tag!"
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    invoke-direct {v0, v1, v2}, Lcom/android/internal/telephony/IccFileHandler;->ParseUICCTLVData([B[I)V
    ...
    .line 578
    const-string v3, "Exception in EVENT_GET_RECORD_SIZE_DONE"
    ...
    .line 630
    const-string v3, "Exception in EVENT_GET_BINARY_SIZE_DONE"
