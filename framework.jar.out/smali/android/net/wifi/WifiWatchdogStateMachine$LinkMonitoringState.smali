...
.method public enter()V
    ...
    invoke-static {v0, v1}, Landroid/net/wifi/WifiWatchdogStateMachine;->access$3602(Landroid/net/wifi/WifiWatchdogStateMachine;Landroid/net/wifi/WifiWatchdogStateMachine$VolumeWeightedEMA;)Landroid/net/wifi/WifiWatchdogStateMachine$VolumeWeightedEMA;
    ...
    invoke-static {v3}, Landroid/net/wifi/WifiWatchdogStateMachine;->access$2404(Landroid/net/wifi/WifiWatchdogStateMachine;)I
...
.method public processMessage(Landroid/os/Message;)Z
    ...
    invoke-static {v14}, Landroid/net/wifi/WifiWatchdogStateMachine;->access$1900(Landroid/net/wifi/WifiWatchdogStateMachine;)Landroid/net/wifi/WifiWatchdogStateMachine$OnlineWatchState;

    move-result-object v14

    #calls: Landroid/net/wifi/WifiWatchdogStateMachine;->transitionTo(Lcom/android/internal/util/IState;)V
    invoke-static {v13, v14}, Landroid/net/wifi/WifiWatchdogStateMachine;->access$3700(Landroid/net/wifi/WifiWatchdogStateMachine;Lcom/android/internal/util/IState;)V
    ...
    invoke-static {v14}, Landroid/net/wifi/WifiWatchdogStateMachine;->access$3400(Landroid/net/wifi/WifiWatchdogStateMachine;)Landroid/net/wifi/WifiWatchdogStateMachine$LinkMonitoringState;
    ...
    invoke-static {v14}, Landroid/net/wifi/WifiWatchdogStateMachine;->access$3100(Landroid/net/wifi/WifiWatchdogStateMachine;)Landroid/net/wifi/WifiWatchdogStateMachine$OnlineState;
    ...
    invoke-static {v14}, Landroid/net/wifi/WifiWatchdogStateMachine;->access$2400(Landroid/net/wifi/WifiWatchdogStateMachine;)I
    ...
    invoke-static {v13}, Landroid/net/wifi/WifiWatchdogStateMachine;->access$2600(Landroid/net/wifi/WifiWatchdogStateMachine;)Lcom/android/internal/util/AsyncChannel;
    ...
    invoke-static/range {v16 .. v16}, Landroid/net/wifi/WifiWatchdogStateMachine;->access$2404(Landroid/net/wifi/WifiWatchdogStateMachine;)I
    ...
    invoke-static {v13}, Landroid/net/wifi/WifiWatchdogStateMachine$BssidStatistics;->access$4000(Landroid/net/wifi/WifiWatchdogStateMachine$BssidStatistics;)J
    ...
    invoke-static {v13}, Landroid/net/wifi/WifiWatchdogStateMachine;->access$3600(Landroid/net/wifi/WifiWatchdogStateMachine;)Landroid/net/wifi/WifiWatchdogStateMachine$VolumeWeightedEMA;
    ...
    invoke-static {v13}, Landroid/net/wifi/WifiWatchdogStateMachine$VolumeWeightedEMA;->access$4100(Landroid/net/wifi/WifiWatchdogStateMachine$VolumeWeightedEMA;)D
    ...
    invoke-static {v13}, Landroid/net/wifi/WifiWatchdogStateMachine;->access$2404(Landroid/net/wifi/WifiWatchdogStateMachine;)I
    ...
    invoke-static {v13, v8, v9}, Landroid/net/wifi/WifiWatchdogStateMachine$BssidStatistics;->access$4002(Landroid/net/wifi/WifiWatchdogStateMachine$BssidStatistics;J)J
